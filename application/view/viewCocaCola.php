  ...
  <body id="bodyColor">
      ...
      <div class="container-fluid">
          ...
          <div id="about" style="display:none;">
              <div class="card">
                      <div class="card-body">
                          <div  class="card-title drinksText"><h2>History of CocaCola in UK</h2></div>
                          <div  class="card-subtitle drinksText"><h3>Charles Howard Candler</h3></div>
                          <div  class="card-text drinksText">Coca-Cola made its debut in the United Kingdom in 1900 when Charles Howard Candler, son of the company's founder Asa Candler, brought the beverage to Britain. The drink quickly gained popularity, and by 1920, the first official bottling plant was established in London. During World War II, Coca-Cola was widely distributed to U.S. troops stationed in the UK, further boosting its recognition and demand among the British public. Post-war, Coca-Cola continued to expand its market presence, opening numerous bottling plants across the country. Today, Coca-Cola is one of the most recognized and consumed soft drinks in the UK, maintaining a significant cultural and economic impact.</div>   
                        <a href="https://www.coca-cola.co.uk/drinks/coca-cola/coca-cola" class="btn btn-primary btn-responsive">Visit Coke</a>                 
                      </div>
                  </div>
          </div>  
                        ...
                        <div class="card-header">
                          <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="#" onclick="toggleRenderMode('polygon')">Polygon</a>
                                <a class="dropdown-item" href="#" onclick="toggleRenderMode('wireframe')">Wireframe</a>
                                <a class="dropdown-item" href="#" onclick="toggleRenderMode('vertex')">Vertex</a>
                              </div>
                            </li>
                          <!-- Dropdown nav-tab -->
                          <li class="nav-item dropdown">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>Ngoc Minh Do,  Email: <a href="mailto:nd305@sussex.ac.uk"> nd305@sussex.ac.uk</a></p>
                </div>
