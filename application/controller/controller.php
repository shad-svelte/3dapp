...
class Controller {
    ...
    // Check if the method exists in the class before calling it
    if ($pageMethod && method_exists($this, $pageMethod)) {
        $this->$pageMethod();
    } else {
        // Handle the error or default behavior here
        echo "Error: Method '$pageMethod' not found in Controller.";
    }
	}
